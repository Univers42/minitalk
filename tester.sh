...
for init in tm tb t1 t2 t3 t4 t5 t6 p_id
do
    export $init=0
done
...
echo -e "${L_Green} [Speed test]\tTime to print 1 000 char ${NC}"
...
if [[ $t1 == 1 || $tm == 1 ]]
then
    echo -e "${L_Green} [Test 1]\tBasic test ${NC}"
...
echo -e "\nIf all was correctly displayed on your server terminal: Perfect, well done! 💪"
...
OBJS_CLIENT_BONUS=$(OBJ_DIR)/client.o $(OBJ_DIR)/utils_bonus.o $(OBJ_DIR)/free.o $(OBJ_DIR)/log.o
OBJS_SERVER_BONUS=$(OBJ_DIR)/server.o $(OBJ_DIR)/utils_bonus.o $(OBJ_DIR)/free.o $(OBJ_DIR)/log.o
